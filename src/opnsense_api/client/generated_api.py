...
class FunctionProxy:
    ...
    def _load_function_module(self):
        ...
        if self._function_module is None:
            ...
            # Build module path: opnsense_api.generated.v25_7_6.opnsense_api_client.api.core.core_firmware_info
            function_module_name = f"{self._module_name}_{self._function_name}"
            module_path = (
                f"opnsense_api.generated.v{self._version_module}."
                f"opnsense_api_client.api.{self._module_name}.{function_module_name}"
            )
