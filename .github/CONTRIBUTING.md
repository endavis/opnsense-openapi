# Contributing to opnsense-openapi
...
```bash
# Clone your fork
git clone https://github.com/endavis/opnsense-openapi.git
cd opnsense-openapi
...
# Local
from opnsense_openapi import module
```
...
```bash
pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ opnsense-openapi==1.0.1a0
```
...
git remote set-url origin https://<token>@github.com/endavis/opnsense-openapi.git
```
...
git remote add upstream https://github.com/endavis/opnsense-openapi.git
...
2. Search existing [Issues](https://github.com/endavis/opnsense-openapi/issues)
